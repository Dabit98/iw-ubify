                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fecha_nac" type="date" class="form-control @error('fecha_nac') is-invalid @enderror" name="fecha_nac" value="{{ $user['fecha_nac'] }}" required autocomplete="fecha_nac" autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                @driver
                                    <a class="btn btn-primary" style="color:white" href="{{ '\Vehiculos\registro' }}">Añadir vehiculo</a>
                                @enddriver
                            </div>
                        </div>
                    </form>
